  ...
  <div class="app-container">
    <el-card>
      <el-form :model="queryParams" ref="queryRef" :inline="true" label-width="90px">
              ...
              <el-form-item label="收款日期" class="col4">
                <el-date-picker
              ...
              <el-form-item label="往来单位" prop="merchantId" class="col4">
                <el-select v-model="queryParams.merchantId" placeholder="请选往来单位" clearable filterable style="width:100%">
        ...
        <el-table-column label="操作" align="right" class-name="small-padding fixed-width">
          <template #default="scope">
            ...
            >
              ...
              <el-button v-if="false" link type="primary" @click="handlePrint(scope.row)">打印</el-button>
          </template>
        </el-table-column>
      </el-table>
